...
--- Before Day-3 ---
I already knew basic Python syntax and how to run scripts with python script.py.
--- 
...
--- After Day-3 ---
I learned how uv manages temporary environments and how to add dependencies with uv add.
---

--- Feedback (Suggestions for the TDS Team) ---
More hands-on examples for `uv add` would help
---
